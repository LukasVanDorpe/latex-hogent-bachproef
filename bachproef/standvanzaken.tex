...
Zoals in vorige hoofdstuk  \ref{ch:inleiding}  vermeld iszal er onderzoek gevoerd worden naar de mogelijke oplossingen waarmee het bedrijf Lockit Rentals mee kampt. Alvorens we deze oplossingen aanbieden is het van belang om inzicht te verweren van gebruikte technologieën. Aangezien de 2 probleemstelling zich voordoen, is de literatuurstudie onderverdeeld in enerzijds de werking van algemene QR-codes alsook de ontwikkeling van een chatbot. Door deze onderwerpen zorgvuldig te bestuderen kunnen we op basis van verweven kennis het onderzoek starten. 
