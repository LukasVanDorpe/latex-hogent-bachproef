...
\begin{table}[h]
    ...
    \begin{tabular}{ c|c|c }
        \cline{2-3}
        & \textbf{\textit{QR-code op papier}} & \textbf{\textit{QR-code op gsm}} \\
        \cline{2-3}        
        \hline
        \textbf{\textit{1. Normaal}} & a & b \\
        \hline
        \textbf{\textit{2. Lichtinval}} & a & b \\
        \hline
        \textbf{\textit{3. Donker}} & a & b \\
        \hline
        \textbf{\textit{4. Beschadigd}} & a & b \\
        \hline
    \end{tabular}
    \captionsetup{justification=centering}
    \caption{Voorbeeldtabel met aangepaste rijen en headers in vetgedrukte tekst en cellen gevuld met "a" en "b".}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \rotatebox{-90}{\includegraphics[width=\textwidth]{graphics/F31_botpress_Acties.jpg}}
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \rotatebox{-90}{\includegraphics[width=\textwidth]{graphics/F32_botpress_Variables.jpg}}
